...
export function FilterPanel({ open, onClose }: FilterPanelProps) {
  ...
  const filterConfigs = [
    { key: "end_year" as const, label: "End Year", placeholder: "Select year" },
    { key: "topic" as const, label: "Topic", placeholder: "Select topic" },
    { key: "sector" as const, label: "Sector", placeholder: "Select sector" },
    { key: "region" as const, label: "Region", placeholder: "Select region" },
    { key: "pestle" as const, label: "PESTLE", placeholder: "Select PESTLE" },
    { key: "source" as const, label: "Source", placeholder: "Select source" },
    { key: "swot" as const, label: "SWOT", placeholder: "Select SWOT" },
    { key: "country" as const, label: "Country", placeholder: "Select country" },
    { key: "city" as const, label: "City", placeholder: "Select city" },
  ];
