...
export function PestChart({ data, isLoading }: PestChartProps) {
  const chartData = useMemo(() => {
    const pestleMap = new Map<string, { count: number; avgIntensity: number; totalIntensity: number }>();
